...
interface RegistrationFormProps {
  onComplete?: (id: string, username: string, image: string, admin: boolean, theme: string, email?: string) => void;
}
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (res.ok) {
          ...
          onComplete?.(user.id, user.username, user.image, user.admin, user.theme, user.email);
        } else {
